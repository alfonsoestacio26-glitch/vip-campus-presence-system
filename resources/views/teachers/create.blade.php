        ...
        <div class="flex items-center gap-3">
            ...
            <div>
                ...
                <p class="text-sm text-slate-400 mt-1">
                    Register a new teacher profile and login credentials
                </p>
            </div>
        </div>
    ...
    <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
        ...
        >
            ...
            <div class="px-6 py-5 border-b border-slate-100 bg-slate-50/50">
                <h2 class="text-sm font-semibold text-slate-700">Teacher Profile Details</h2>
                <p class="text-xs text-slate-400 mt-0.5">Basic profile details for the teacher.</p>
            </div>
            ...
            <div class="px-6 py-5 border-t border-b border-slate-100 bg-slate-50/50">
                ...
                <p class="text-xs text-slate-400 mt-0.5">Used by the teacher to log in to the VIP presence portal.</p>
            </div>
