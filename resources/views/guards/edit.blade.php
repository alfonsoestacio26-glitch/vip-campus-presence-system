...
<div class="max-w-4xl mx-auto">
        ...
        <div class="flex items-center gap-3">
            ...
            <div>
                ...
                <p class="text-sm text-slate-400 mt-1">
                    Update guard profile details and account details
                </p>
            </div>
        </div>
    ...
    <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
        ...
        <form
            action="{{ route('guards.update', $guard) }}"
            method="POST"
        >
            @csrf
            @method('PUT')
            ...
            <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    <input
                        ...
                        id="employee_no"
                        name="employee_no"
                        value="{{ old('employee_no', $guard->employee_no) }}"
                        required
                ...
                <div>
                    ...
                    <input
                        ...
                        id="contact_number"
                        name="contact_number"
                        value="{{ old('contact_number', $guard->contact_number) }}"
                        class="w-full px-4 py-3 border border-slate-200 rounded-xl text-sm text-slate-700 outline-none focus:ring-2 focus:ring-[#123b70]/20 focus:border-[#123b70]"
            ...
            <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    <input
                        ...
                        id="email"
                        name="email"
                        value="{{ old('email', $guard->user->email ?? '') }}"
                        required
                        class="w-full px-4 py-3 border border-slate-200 rounded-xl text-sm text-slate-700 outline-none focus:ring-2 focus:ring-[#123b70]/20 focus:border-[#123b70]"
